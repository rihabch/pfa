...
class Ui_Ajout_Competence(object):
    def setupUi(self, Form):
        ...
        self.total_piece = QtWidgets.QLabel(self.formLayoutWidget_4)
        self.total_piece.setObjectName("total_piece")
        self.formLayout_4.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.total_piece)
        self.retouches_pieces = QtWidgets.QLabel(self.formLayoutWidget_4)
        self.retouches_pieces.setObjectName("retouches_pieces")
        self.formLayout_4.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.retouches_pieces)
        self.retouche_comp = QtWidgets.QLineEdit(self.formLayoutWidget_4)
        self.retouche_comp.setObjectName("retouche_comp")
        self.formLayout_4.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.retouche_comp)
    ...
    def retranslateUi(self, Form):
        ...
        self.total_piece.setText(_translate("Form", "Nombre Total de Pièces:"))
        self.retouches_pieces.setText(_translate("Form", "Nombre de Pièces Retouchées:"))
