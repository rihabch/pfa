...
class Ajouter_Operation(QWidget, Ui_Ajouter_Op):
    ...
    def add(self):
        ...
        self.model.setData(self.model.index(nbr, 1), nom_op)
        self.model.setData(self.model.index(nbr, 2), minutage)
        self.model.setData(self.model.index(nbr, 3), machine)
        #self.model.setData(self.model.index(nbr, 4), critere)
        self.model.setData(self.model.index(nbr, 5), "admin_02")
